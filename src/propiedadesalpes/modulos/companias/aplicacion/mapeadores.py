...
from propiedadesalpes.modulos.companias.dominio.objetos_valor import InformacionGeoespacial, DatosGreograficos, Direccion, Localizacion, TipoIndustria, DocumentoIdentidad, Compania
