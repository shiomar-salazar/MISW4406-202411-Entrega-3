...
from modulos.contratos.aplicacion.queries.obtener_por_ids import ObtenerContratoPorIds
...
@bp.route('/<id_compania>/<id_propiedad>', methods=('GET',))
def dar_contrato_por_ids_usando_query(id_compania, id_propiedad):
    try:
        map_contrato = MapeadorContratoDTOJson()
        query_resultado = ejecutar_query(ObtenerContratoPorIds(id_compania, id_propiedad))
